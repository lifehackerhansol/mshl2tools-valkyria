#ifndef LIBVALKYRIA_H
#define LIBVALKYRIA_H

/*
	libvalkyria - a fundamental framework for NDS development [V2]
	...
	***
	...
	You may use libvalkyria in both open source and proprietary software without restriction.
	libvalkyria is distributed AS-IS without WARRANTY.
...
#define ROMVERSION "1.13c.111211 Phase:Rebirth"
...
#define ROMENV "DevKitARMr34 + libnds 1.5.4 (FIFO) +\nlibfat r4737(modified)"
#else
